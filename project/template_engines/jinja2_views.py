...
from wsgifire.extensions.templates.jinja2 import render_template

@simple_response
def home(request):
    """Small demo using jinja2 templating."""
    return render_template("jinja2/home.html",None)
...
def add_numbers_post(request):
    ...
    Small demo of using forms to POST data and jinja2 templating.
    """
    value = 0
    message = ''
    if request.POST:
    ...
    return render_template("jinja2/add_numbers_post.html",data)
